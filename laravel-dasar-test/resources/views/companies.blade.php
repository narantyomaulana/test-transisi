                                    ...
                                    @foreach ($get_all_company as $key => $c)
                                        <tr>
                                            ...
                                            <td class="">
                                                ...
                                                <span title="Pdf" data-bs-toggle="tooltip">
                                                    <a class="btn btn-action btn-light" href="{{ route('company.export.pdf', ['companyId' => $c->id]) }}">
                                                        <i class="fas fa-file-pdf"></i>
                                                    </a>
                                                </span>
                                                {{-- <a href="{{ route('company.export.pdf', ['companyId' => $c->id]) }}" class="btn btn-success"><i class="fa fa-file-pdf"></i> Export PDF</a> --}}
